...
<div class="mb-1">
    <label for="note_pdf" class="form-label">Upload File <i class="bi-question-circle text-body ms-1"
            data-bs-toggle="tooltip" data-bs-placement="top" title="Enter The Note as a pdf format"></i></label>

    <input type="file" accept=".pdf, .doc, .docx" class="form-control @error('note_pdf') is-invalid @enderror"
        name="note_pdf" id="file" placeholder="Note Document">
