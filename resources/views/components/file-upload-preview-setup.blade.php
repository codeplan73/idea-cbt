...
<div class="mb-1">
    <label for="setup_pdf" class="form-label">Upload Setup File <i class="bi-question-circle text-body ms-1"
            data-bs-toggle="tooltip" data-bs-placement="top" title="Enter The Note as a pdf format"></i></label>

    <input type="file" accept=".pdf, .doc, .docx" class="form-control @error('setup_pdf') is-invalid @enderror"
        name="setup_pdf" id="file" placeholder="Note Document">
    ...
    fileInput.addEventListener('change', function() {
        ...
        if (file) {
            ...
            reader.onloadend = function() {
                ...
                pdfPreview.height = '500px'; // Set the height (adjust as needed)
