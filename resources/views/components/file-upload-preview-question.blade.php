...
<div class="mb-1">
    <label for="question_pdf" class="form-label">Upload File <i class="bi-question-circle text-body ms-1"
            data-bs-toggle="tooltip" data-bs-placement="top" title="Enter The Note as a pdf format"></i></label>

    <input type="file" accept=".pdf, .doc, .docx" class="form-control @error('question_pdf') is-invalid @enderror"
        name="question_pdf" id="file" placeholder="Note Document">
