...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/auth/css/vendor.min.css') }}">

    <!-- CSS Front Template -->
    <link rel="stylesheet" href="{{ asset('assets/auth/css/theme.minc619.css?v=1.0') }}">

    <link rel="preload" href="{{ asset('assets/auth/css/theme.min.css') }}" data-hs-appearance="default"
        as="style">
    <link rel="preload" href="{{ asset('assets/auth/css/theme-dark.min.css') }}" data-hs-appearance="dark"
        as="style">
...
<body>
    ...
    <script src="{{ asset('assets/auth/js/hs.theme-appearance.js ') }}"></script>

    <!-- ========== MAIN CONTENT ========== -->
    <main id="content" role="main" class="main">
        <div class="position-fixed top-0 end-0 start-0 bg-img-start"
            style="height: 32rem; background-image: url(assets/auth/svg/components/card-6.svg);">
            <!-- Shape -->
    ...
    <script src="{{ asset('assets/auth/js/vendor.min.js') }}"></script>

    <!-- JS Front -->
    <script src="{{ asset('assets/auth/js/theme.min.js') }}"></script>
