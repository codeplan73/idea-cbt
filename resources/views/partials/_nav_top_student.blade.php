 <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand" style="display: none;">
     ...
     <a class="navbar-brand me-1 me-sm-3" href="/student">
         <div class="d-flex align-items-center"><img class="me-2" src="{{ asset('assets/logo/logo.png') }}"
                 alt="" width="40" /><span class="font-sans-serif text-primary">El-Amin CBT</span></div>
     </a>
         ...
         <li class="nav-item dropdown">
             ...
             <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                 ...
                 <div class="bg-white dark__bg-1000 rounded-2 py-2">
                     ...
                     <a class="dropdown-item" href="/student-profile">Profile &amp; account</a>
                     <div class="dropdown-divider"></div>

                     <a class="dropdown-item" href="/student-profile">Settings</a>
